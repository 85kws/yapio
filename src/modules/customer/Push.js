...
export default function Push({ businessId, theme }) {
  ...
  if (!items.length) return <View style={s.empty}><Ionicons name="notifications-outline" size={48} color={COLORS.muted} /><Text style={s.emptyText}>Henüz duyuru yok.</Text></View>;

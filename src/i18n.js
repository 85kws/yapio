...
const STRINGS = {
  tr: {
    ...
    working_hours: 'Çalışma Saatleri', open_time: 'Açılış', close_time: 'Kapanış', services: 'Hizmetler', service_name_ph: 'Hizmet adı', appointments: 'Randevular', no_appointments: 'Henüz randevu yok.', cancel_short: 'İptal', confirmed_short: '✓ onaylı', hours_saved: 'Çalışma saatleri', closed_days: 'Kapalı Günler (dokun = kapat)',
    ...
    scan_qr: 'QR Okut', scan_hint: 'Müşterinin kart QR kodunu çerçeveye getir', camera_permission: 'QR okutmak için kamera izni gerekli.', grant_permission: 'İzin Ver', invalid_qr_title: 'Geçersiz QR', invalid_qr_body: 'Bu kod bu işletmeye ait bir karta uymuyor.', checkin_done: 'Giriş kaydedildi', loyalty_qr_note: 'Bu kodu işletmeye okut, her ziyarette damga eklensin.',
    ...
    no_apps_yet: "Henüz app indirmedin.\nVitrin'den keşfet.", search_business: 'İşletme ara...', all: 'Tümü', no_apps_filter: "Bu filtrede aktif app yok.\nİşletmem sekmesinden kendi app'ini yayınla.", got_it2: 'Anladım',
    pending_apps_count: 'bekleyen başvuru', no_pending_apps: 'Bekleyen başvuru yok.', company: 'Şirket', individual: 'Şahıs', private_short: 'özel',
    step_label: 'Adım', choose_sector: 'Sektörünü seç', choose_template: 'Şablon seç', template_sub: 'için hazır kurulum. Özelliğe dokun → ne yaptığını gör:', business_info: 'İşletme bilgileri', business_name_req: 'İşletme adı *', biz_name_ph: 'Örn: Yiğit Berber', short_desc: 'Kısa açıklama', desc_ph2: 'Müşteriye görünecek tanıtım', addr_ph: 'Çankaya, Ankara', create_app: "App'i Oluştur", onboarding_hint: 'App taslak olarak kaydedilir. Sonra düzenleyip yayınlarsın.',
    ...
    reject: 'Reddet', activate: 'Aktifleştir', suspend: 'Askıya Al',
    mod_soon: 'Bu modülün yönetimi yakında.',
    total_income: 'Toplam Tahsilat', add_payment: 'Ödeme ekle', customer_name_ph: 'Müşteri adı', amount_ph: 'Tutar ₺', payment_records: 'Kayıtlar', customer_fallback: 'Müşteri',
    total_paid: 'Toplam Ödeme', no_payments: 'Ödeme kaydın yok.', paid_label: 'Ödendi',
    no_team: 'Ekip bilgisi yok.', continue_btn: 'Devam',
  },
  en: {
    ...
    working_hours: 'Working Hours', open_time: 'Open', close_time: 'Close', services: 'Services', service_name_ph: 'Service name', appointments: 'Appointments', no_appointments: 'No appointments yet.', cancel_short: 'Cancel', confirmed_short: '✓ confirmed', hours_saved: 'Working hours', closed_days: 'Closed Days (tap = close)',
    ...
    scan_qr: 'Scan QR', scan_hint: "Point at the customer's card QR code", camera_permission: 'Camera permission is required to scan QR.', grant_permission: 'Grant Permission', invalid_qr_title: 'Invalid QR', invalid_qr_body: "This code doesn't match a card for this business.", checkin_done: 'Check-in saved', loyalty_qr_note: 'Show this code to staff to collect a stamp each visit.',
    ...
    no_apps_yet: "You haven't installed any apps yet.\nDiscover from the storefront.", search_business: 'Search business...', all: 'All', no_apps_filter: "No active apps in this filter.\nPublish your own from the My Business tab.", got_it2: 'Got it',
    pending_apps_count: 'pending applications', no_pending_apps: 'No pending applications.', company: 'Company', individual: 'Individual', private_short: 'private',
    step_label: 'Step', choose_sector: 'Choose your sector', choose_template: 'Choose a template', template_sub: 'ready setup. Tap a feature → see what it does:', business_info: 'Business info', business_name_req: 'Business name *', biz_name_ph: 'e.g. Joe Barber', short_desc: 'Short description', desc_ph2: 'Intro shown to customers', addr_ph: 'City, Country', create_app: 'Create App', onboarding_hint: 'The app is saved as a draft. You edit and publish later.',
    ...
    reject: 'Reject', activate: 'Activate', suspend: 'Suspend',
    mod_soon: 'Module management coming soon.',
    total_income: 'Total Revenue', add_payment: 'Add Payment', customer_name_ph: 'Customer name', amount_ph: 'Amount ₺', payment_records: 'Records', customer_fallback: 'Customer',
    total_paid: 'Total Payments', no_payments: 'No payment records.', paid_label: 'Paid',
    no_team: 'No team info.', continue_btn: 'Continue',
  },
};
